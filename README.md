...
- 🏢 **Whatnot** — Senior Software Engineer, leading .NET services for high-volume marketplace operations
- 🛒 **Vat19** — Senior Engineer, building e-commerce APIs, inventory, pricing, and order systems
- ⚡ Reduced deployment turnaround from **half a day to under one hour** through Azure DevOps CI/CD
- 🧪 Built automated test coverage for critical checkout, payout, payment, and shipping workflows
- 📊 Optimized SQL Server schemas, indexes, stored procedures, and high-volume transactional workloads
- 👥 Mentored distributed engineering teams and established development and code-review standards
